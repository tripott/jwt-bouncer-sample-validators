...
const mockNullPublicKeyRequestObject = require('../../fixtures/jwt/whitelistitem-null-jku-token-null-jku-pem-null')
...
test(`jwt-validator: null whitelistitem jku, null token jku, null whitelistitem jwkPublicKeyPEM :(`, async t => {
  t.plan(4)
